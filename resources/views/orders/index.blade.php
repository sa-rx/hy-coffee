                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="{{route('orders.update',$order)}}" method="post">
                                    @csrf
                                    @method('PUT')
                                        <select class="form-select form-select-sm" aria-label="Default select example"  name="status" id="1"   @isset($order) value="{{$orderStatu->status}}" @endisset>
                                            <option value="0" {{old('status',$orderStatu->status)=="0"? 'selected':''}}  value="$orderStatu->status">لم يدفع</option>
                                            <option value="1" {{old('status',$orderStatu->status)=="1"? 'selected':''}}  value="$orderStatu->status">دفع</option>            
                                        </select>
                                        <button type="submit" class="btn btn-info btn-sm">تعديل </button>
                                </form>
                            </td>
                            ...
                            <td>
                                ...
                                <form action="{{route('orders.update',$order)}}" method="post">
                                    ...
                                    @method('PUT')
                                        ...
                                        <select class="form-select form-select-sm" aria-label="Default select example"  name="status" id="1"   @isset($order) value="{{$orderDate->status}}" @endisset>
                                            <option value="0" {{old('status',$orderDate->status)=="0"? 'selected':''}}  value="$orderDate->status">لم يدفع</option>
                                            <option value="1" {{old('status',$orderDate->status)=="1"? 'selected':''}}  value="$orderStatu->status">دفع</option>            
                                        </select>
